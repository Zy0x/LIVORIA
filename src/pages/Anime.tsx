...
function AddCard({ viewMode, onClick }: { viewMode: ViewMode; onClick: () => void }) {
  if (viewMode === 'list') {
    return (
      <button data-add-card-trigger="anime" onClick={onClick} className="flex items-center gap-4 p-4 rounded-2xl border-2 border-dashed border-border bg-muted/20 hover:border-primary/50 hover:bg-primary/5 transition-all group w-full">
  ...
  return (
    <button data-add-card-trigger="anime" onClick={onClick} className="h-full rounded-2xl border-2 border-dashed border-border bg-muted/20 hover:border-primary/50 hover:bg-primary/5 transition-all group flex flex-col items-center justify-center cursor-pointer" style={{ aspectRatio: '2 / 3.35' }}>
      ...
      {pageTab === 'semua' && (
        <>
          ...
          <div className="space-y-3 mb-6 rounded-2xl border border-border bg-card p-3 sm:p-4 shadow-sm">
            {/* Row 1: Search + Filter toggle (mobile) + View toggle */}
            ...
            {/* Row 2: Filters - hidden on mobile unless toggled */}
