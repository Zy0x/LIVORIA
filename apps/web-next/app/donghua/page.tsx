...
export default async function DonghuaPage({ searchParams }: DonghuaPageProps) {
  const params = await searchParams;
  const state = await getMediaPreview('donghua', normalizeMediaQuery({
