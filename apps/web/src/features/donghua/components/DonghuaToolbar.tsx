...
import type { DonghuaPageTab } from '../types/donghua.types';

interface DonghuaToolbarProps {
  pageTab: DonghuaPageTab;
  watchlistCount: number;
  onPageTabChange: (tab: DonghuaPageTab) => void;
}

export function DonghuaToolbar({ pageTab, watchlistCount, onPageTabChange }: DonghuaToolbarProps) {
  return (
