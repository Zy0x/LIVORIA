...
const Donghua = () => {
  ...
  const { data: donghuaList = [], isLoading, isFetching } = useDonghuaList();
  const showListSkeleton = isLoading || (isFetching && donghuaList.length === 0);
  const {
    pageSize,
    setPageSize,
    watchlistPageSize,
  ...
  useMediaPageEntrance(containerRef, 'donghua', showListSkeleton);
