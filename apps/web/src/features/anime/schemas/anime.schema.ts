...
export const animeStatusSchema = z.enum(['on-going', 'completed', 'planned']);
export const animeWatchStatusSchema = z.enum(['none', 'want_to_watch', 'watching', 'watched']);
...
export const animeSchema = z.object({
  ...
  watch_status: animeWatchStatusSchema.optional().default('none'),
});

export type AnimeSchemaInput = z.infer<typeof animeSchema>;
