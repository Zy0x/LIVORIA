...
import { Chrome, Eye, EyeOff, Lock, Mail, Shield } from 'lucide-react';
...
export function AuthLogo({ logoRef }: AuthLogoProps) {
  return (
    ...
    <div ref={formRef} className="glass-card p-8">
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-2.5 rounded-lg bg-primary text-primary-foreground font-medium text-sm hover:opacity-90 transition-all duration-200 disabled:opacity-50 shadow-lg shadow-primary/20"
        >
      ...
      <button
        ...
        disabled={loading}
        className="w-full flex items-center justify-center gap-3 py-2.5 rounded-lg border border-input bg-background text-sm font-medium hover:bg-accent transition-all duration-200 disabled:opacity-50"
      >
