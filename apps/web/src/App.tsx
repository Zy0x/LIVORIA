      ...
      <BrowserRouter>
        <Suspense fallback={<LoadingState fullScreen label="Memuat aplikasi..." />}>
          <Routes>
            ...
            <Route path="/login" element={<RouteShell name="login" fallback={<LoadingState fullScreen label="Memuat halaman masuk..." />}><Auth /></RouteShell>} />
            ...
            <Route path="/" element={<ProtectedRoute><GlobalEffects /><Layout /></ProtectedRoute>}>
              ...
              <Route path="dashboard" element={<RouteShell name="dashboard" fallback={<DashboardSkeleton />}><Dashboard /></RouteShell>} />
