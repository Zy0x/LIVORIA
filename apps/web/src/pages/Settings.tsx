...
} from '@/features/settings/services/settings-backup.repository';

const IMPORTABLE_TABLES: readonly SettingsBackupTable[] = ['anime', 'donghua', 'waifu', 'obat', 'tagihan', 'tagihan_history', 'struk'] as const;
    ...
    try {
      ...
      if (importMode === 'overwrite') {
        for (const table of IMPORT_DELETE_ORDER) {
          await deleteSettingsRowsForUser(table, user.id);
        }
      }
