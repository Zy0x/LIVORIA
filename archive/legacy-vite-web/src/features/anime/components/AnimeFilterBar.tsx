...
interface AnimeFilterBarProps {
  ...
  onViewModeChange: (value: AnimeViewMode) => void;
  filter: AnimeFilterStatus;
  onFilterChange: (value: AnimeFilterStatus) => void;
  movieFilter: AnimeMovieFilter;
  onMovieFilterChange: (value: AnimeMovieFilter) => void;
  watchStatusFilter: AnimeWatchlistFilter;
  onWatchStatusFilterChange: (value: AnimeWatchlistFilter) => void;
  ...
  onSortModeChange: (value: AnimeSortMode) => void;
  sortReverse: boolean;
