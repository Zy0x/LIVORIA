...
import { AdminRestoreConfirmModal } from '@/features/admin/AdminRestoreConfirmModal';
import { toast } from '@/hooks/use-toast';
import Breadcrumb from '@/components/Breadcrumb';

import { TABLE_CONFIG_MAP, fmt, fmtShort, getAdminSession, type AdminTab, type TableStat } from '@/features/admin/admin-page-helpers';
  ...
  return (
    <div ref={containerRef} className="w-full max-w-4xl mx-auto p-4 sm:p-6 pb-20">
      ...
      <AdminRestoreConfirmModal
        ...
        onCancel={() => { setShowRestoreConfirm(false); setPendingRestoreData(null); setRestoreConfirmText(''); }}
